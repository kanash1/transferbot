...
@Component
class TelegramUserPersistenceGateway(private val repository: IUserJpaRepository): IUserPersistenceOutputPort {
    ...
    override fun findUserByPlatformId(platformId: String): User =
        repository.findByTelegramUserId(platformId.toLong())?.toDomain() ?: throw EntityNotFoundException("User not found")
}